    ...
    try {
      ...
      out.write("    ");
            ...
            for(Noticia n : todaslasnoticias){
               ...
               no= new Noticia(titulo, noticia, imagen);
               NoticiasTodas.add(n);
...
out.print(ni.getNoticia());
      ...
      out.write("                        <div class=\"field-container\">\n");
      out.write("                            <i class=\"fa fa-key fa-lg\" aria-hidden=\"true\"></i>\t\n");
      out.write("                            <input type=\"password\" class=\"field\" placeholder=\"*******\" name=\"confircontra\" id=\"confircontra\" onblur=\"confirma()\" required/> <br/>\n");
      out.write("                        </div>\n");
      ...
      out.write("                    $(\"#menuF li a\").removeClass(\"active\").attr('href', 'http://localhost:44009/WORK-INC-WODY2/ConsultarNoticias?#openModal');\n");
      out.write("                    $(this).find(\"#menuF\").addClass(\"active\").attr('href', 'http://localhost:44009/WORK-INC-WODY2/ConsultarNoticias?#openModal');\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("            $(function () {\n");
      ...
      out.write("                    $(\"#reg\").attr('href', 'http://localhost:44009/WORK-INC-WODY2/ConsultarNoticias?#openModal');\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("\n");
      out.write("\n");
